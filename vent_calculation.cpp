...
#define ERRORCODE_POSITIVE_PRESSURE_480                      -32;
#define ERRORCODE_NEGATIVE_PRESSURE_480                      -33;
...
double vent_calculation::get_FIA_vent_area(int system_technology_index, double peek_mass_flow_rate,
                                           double total_agent_mass_cylinder_bank, double temperature) {
    ...
    switch (extinguishant_agent_index) {
        ...
        case 5:
            return getVentAreaFIAforAgentIndex_5(system_technology_index, peek_mass_flow_rate,
                                                 total_agent_mass_cylinder_bank, temperature);
        case 6:
            return ERRCODE_Agent_IG_55PA_Not_Covered_in_FIA;
        case 7:
            return getVentAreaFIAforAgentIndex_7(system_technology_index, peek_mass_flow_rate,
                                                 total_agent_mass_cylinder_bank, temperature);
        case 8:
            return getVentAreaFIAforAgentIndex_8(system_technology_index, peek_mass_flow_rate,
                                                 total_agent_mass_cylinder_bank, temperature);
            ...
            if (relative_humidity > 20 && relative_humidity < 80) {
                if (existing_vent_area > 0) {
                    ...
                    double positive_pressure = 48.359 * (0.81 + 0.51 * (relative_humidity) / 100) *
                                               (4.2 *
                                                log(enclosure_volume / (existing_vent_area) * design_concentration /
                                                    discharge_time
                                                ) - 27.922);
...
double vent_calculation::getVentAreaFIAforAgentIndex_5(int system_technology_index, double peak_mass_flow_rate,
                                                       double total_agent_mass_cylinder_bank, double temperature) {
    ...
    double specific_volume_of_homogenious_mixture = design_concentration * agent_volume_at_given_condtion / 100 +
                                                    (100 - design_concentration) / 100 * specific_vapour_vol_air;
    ...
    if (system_technology_index == 1) {
        required_vent_area = safety_factor_vent_area * peak_mass_flow_rate * agent_volume_at_given_condtion /
                             sqrt(pressure_limit * specific_volume_of_homogenious_mixture);
        ...
        required_vent_area = safety_factor_vent_area * constant_mass_flow * agent_volume_at_given_condtion /
                             sqrt(pressure_limit * specific_volume_of_homogenious_mixture);
        //cout <<"required_vent_area =" << required_vent_area <<endl;
    }
...
double vent_calculation::getVentAreaFIAforAgentIndex_7(int system_technology_index, double peak_mass_flow_rate,
                                                       double total_agent_mass_cylinder_bank, double temperature) {
    ...
    //cout << "specific_volume_of_homogenious_mixture ="<< specific_volume_of_homogenious_mixture<<endl;
    if (system_technology_index == 1) {
        req_vent_area = safety_factor_vent_area * peak_mass_flow_rate * agent_volume_at_given_condtion /
                        sqrt(pressure_limit * specific_volume_of_homogenious_mixture);
        //cout << "req_vent_area ="<< req_vent_area<<endl;
    } else {
        double constant_mass_flow = total_agent_mass_cylinder_bank / discharge_time;
        req_vent_area = safety_factor_vent_area * constant_mass_flow * agent_volume_at_given_condtion /
                        sqrt(pressure_limit * specific_volume_of_homogenious_mixture);
    }
...
double vent_calculation::getVentAreaFIAforAgentIndex_8(int system_technology_index, double peak_mass_flow_rate,
                                                       double total_agent_mass_cylinder_bank, double temperature) {
...
double vent_calculation::get_FSSA_vent_area() {
    switch (extinguishant_agent_index) {
        case 1:
            return getVentAreaFSSAforAgentIndex_1();
        case 2:
            return getVentAreaFSSAforAgentIndex_2();
        case 3:
            return getVentAreaFSSAforAgentIndex_3();
        case 4:
            return getVentAreaFSSAforAgentIndex_4();
        case 5 :
            return getVentAreaFSSAforAgentIndex_5();
        case 6 :
            return getVentAreaFSSAforAgentIndex_6();
        case 7 :
            return getVentAreaFSSAforAgentIndex_5();
        case 8:
            return getVentAreaFSSAforAgentIndex_8();
    }
}

double vent_calculation::getVentAreaFSSAforAgentIndex_1() {
...
double vent_calculation::getVentAreaFSSAforAgentIndex_2() {
...
double vent_calculation::getVentAreaFSSAforAgentIndex_3() {
        ...
        if (discharge_time > 6 && discharge_time < 10) {
            if (existing_vent_area > 0) {
                ...
                if (positive_pressure > pressure_limit || negative_pressure > pressure_limit) {
                    ...
                    if (positive_pressure <= 479) {
                        return getVentAreaFSSAIndex_3();
                    } else {
                        cout << "Positive pressure is higher than limit = 479" << endl;
                    }
                    if (negative_pressure <= 479) {
                        return getVentAreaFSSAIndex_3();
                    } else {
...
double vent_calculation::getVentAreaFSSAforAgentIndex_4() {
...
double vent_calculation::getVentAreaFSSAforAgentIndex_5() {
...
double vent_calculation::getVentAreaFSSAforAgentIndex_6() {
...
double vent_calculation::getVentAreaFSSAforAgentIndex_8() {
...
double vent_calculation::getVentAreaFIAIndex_3() {
    ...
    double negative_vent_area =
            (0.04589 * enclosure_volume * safety_factor_vent_area * design_concentration) / discharge_time *
            pow((pressure_limit / (1.68 - 1.79 * (relative_humidity) / 100)), -0.9622);
